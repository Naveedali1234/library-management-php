...
<div class="preload">
 ...
 <div class="row panel panel-primary add_student_well">
  <div class="panel-heading bg-primary"><h3><i class="glyphicon glyphicon-plus"></i> List of Issued Books</h3></div>
   <div class="col-md-12">
  ...
  <table cellpadding="0" cellspacing="0" border="0" class="table table-hover table-striped table-bordered" id="example">
      ...
      <?php 
         ...
         $user_query=mysql_query("select book_title,accession_no,book_author,registration_no,isbn,date_of_borrowed from borrowing_info JOIN book on borrowing_info.barcode_id=book.barcode_id 
                  ")or die(mysql_error());
